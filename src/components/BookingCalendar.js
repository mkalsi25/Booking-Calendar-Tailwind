          ...
          <>
            {new Date(avails.date).getMonth() === load && (
              <div
                ...
                className={
                  avails.bookable
                    ? "h-28 sm:h-44 bg-gradient-to-tr from-yellow-600 to-red-900 text-white flex items-end justify-center p-4 border border-white transform duration-200 ease-in-out scale-100 hover:scale-105"
                    : "h-28 sm:h-44 bg-gray-400 flex items-end justify-center p-4 border border-gray-300 text-white"
                }
              >
                <div>
